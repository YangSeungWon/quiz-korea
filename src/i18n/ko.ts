...
const ko: TranslationStrings = {
  ...
  'maps.downloadNumberPdf': '번호형 PDF 다운로드',
  'maps.previewBlank': '백지도 미리보기',
  'maps.previewLabel': '이름 라벨 미리보기',
  'maps.previewNumber': '번호형 학습지 미리보기',
  'maps.styleColor': '컬러',
  'maps.styleBw': '흑백',
  'maps.orientPortrait': '세로',
  'maps.orientLandscape': '가로',
  'maps.optBw': '흑백',
  ...
  'results.shareKakao': '카카오톡으로 공유',
  'results.kakaoCardButton': '퀴즈 풀어보기',
  'results.shareImage': '이미지로 공유',
  'results.copied': '복사됨!',
  'results.resultCopied': '결과가 복사되었어요',
